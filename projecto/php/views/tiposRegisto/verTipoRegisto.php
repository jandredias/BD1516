...
<a href="index.php?page=tiposRegisto&accao=adicionaCampo&tid=<?php
echo $tipoRegisto->typeid ?>"
   class="mdl-button mdl-js-button mdl-button--raised
          mdl-js-ripple-effect"
   style="width:200px;margin:0 auto;">Adicionar campo</a>
<br>
  ...
  <tbody>
    <?php
     foreach($tipoRegisto->campos as $campo): ?>
      <tr>
        <td><a
 href="index.php?page=tiposRegisto&accao=verTipoRegisto&tid=<?php
 echo $_GET['tid'] ?>&removeCampoID=<?php echo $campo->campocnt
 ?>">X</a></td>
        <td><?php echo $campo->campocnt ?></td>
        <td style="text-align:center;"><?php echo $campo->nome ?>
	</td>
      </tr>
    <?php endforeach; ?>
  </tbody>
