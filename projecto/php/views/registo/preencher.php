...
<form action="index.php?page=registo&accao=inserir" method="post">
  ...
  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
    <input class="mdl-textfield__input" type="text" name="<?php echo $campo->campocnt ?>">
    <label class="mdl-textfield__label" for="<?php echo $campo->campocnt ?>"><?php echo $campo->nome; ?></label>
  </div>
  <br />
  <?php } ?>
